...
class Sisow_Gateway_Giropay extends Sisow_Gateway_Abstract
{
	...
	{
		wp_enqueue_script( "sisow-giropayeps-script", plugins_url( 'JS/giropay.min.js', dirname(__FILE__) ), array('jquery'));
		wp_enqueue_style( "sisow-giropayeps-css", plugins_url( 'CSS/giropay.min.css', dirname(__FILE__) ));
	}
